...
#define CUSTOMHID_OFF_KEYBOARD_HID_DESC         0x32

#define CUSTOMHID_SIZ_DEVICE_DESC               18
#define CUSTOMHID_SIZ_CONFIG_DESC               41+9+9+7+7
#define CUSTOMHID_SIZ_REPORT_DESC               33 // 162
#define  CUSTOMHID_KEYBOARD_SIZ_REPORT_DESC     61 
...
extern const uint8_t CustomHID_KeyBoardReportDescriptor[CUSTOMHID_KEYBOARD_SIZ_REPORT_DESC];
